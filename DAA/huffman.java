...
class DAAPractical4 {
    public static void createHuffmanTree(String text) {
        ...
        System.out.println("\n\nHuffman Codes of the characters are: " + huffmanCode);
    ...
    public static void main(String args[]) {
        ...
        boolean nextMsg = true;
        Scanner sc = new Scanner(System.in);

        while (nextMsg) {
            System.out.println("Enter message to send: ");
            String t1 = sc.next();
            String text1 = t1.replaceAll(" ", "");
            System.out.println("Compressed msg to send: ");
            createHuffmanTree(text1);

            System.out.println("\n\nWant to send more message?[yes/no]");
